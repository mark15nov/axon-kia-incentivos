...
Tras la validación de VIN del periodo ${VM_PERIODO}, se rechazaron ${vins.length} unidad(es) del incentivo Variable Margin por los siguientes motivos:
...
export default function VariableStep5ValidacionVin() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle
        ...
        desc="De cada factura se extrae el VIN y se cruza contra el forecast y la oferta comercial. Se detecta qué unidades cumplen y cuáles se rechazan (y por qué), y se notifica el rechazo al dealer."
