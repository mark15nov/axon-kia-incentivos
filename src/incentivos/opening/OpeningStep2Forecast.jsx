...
import {
  ofForecast, ofForecastDealer, ofForecastResumen, ofBrainMetodologia,
  OF_UMBRAL_META
  ...
  return (
    <div className="space-y-6">
      <SectionTitle
        ...
        title="Forecast de financiamiento por dealer"
        desc="Sobre el histórico de los últimos 24 meses se estima, por dealer y por modelo, cuántas unidades se financiarán y cumplirán la meta de crédito del periodo. KIA BRAIN corre la estimación y explica cómo llegó a cada cifra."
            ...
            <div className="flex items-center gap-3.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-white/70 mt-0.5 max-w-md leading-snug">
                  Estima la contratación de crédito por dealer y modelo con 24 meses de originación + VQM, ajustando estacionalidad y tendencia.
                </p>
              </div>
            </div>
            <button
          ...
          <div className="p-5 bg-white animate-fade-up">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm leading-relaxed">
                ...
                <strong> {r.dealersMeta} de {r.dealers} dealers</strong> superan su meta con probabilidad ≥ {OF_UMBRAL_META}%, y {r.paresMeta} de {r.pares} pares dealer·modelo quedan en meta.
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Kpi label="Dealers en meta" value={listo ? `${r.dealersMeta} / ${r.dealers}` : `— / ${r.dealers}`} sub={`Probabilidad ≥ ${OF_UMBRAL_META}%`} />
      ...
      <Card className="overflow-hidden">
        <div className="px-5 py-4 border-b border-kia-line space-y-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <Pill tone="gray">{filtrados.length} de {ofForecast.length} dealers</Pill>
          </div>
          ...
          <td colSpan={7} className="px-5 py-4">
            <div className="rounded-xl bg-white border border-kia-line p-4 animate-fade-up whitespace-normal">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
                {d.modelos.map(m => {
                  const ok = m.prob >= OF_UMBRAL_META
                  return (
