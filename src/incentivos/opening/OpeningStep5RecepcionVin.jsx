...
import { fmtMXN } from '../../data/openingFee.js'

// Resultado simulado del escaneo del .zip.
const RES = { facturas: 126, pdf: 126, xml: 126, vin: 126, monto: 54180000, pareadas: 124, obs: 2, archivos: 252 }

const PREVIEW = [
  { vin: '3KPA24AD1PE520314', folio: 'OF-5201', dealer: 'KIA Santa Fe', modelo: 'Sportage', monto: 549000 },
  { vin: 'KNAD5813XP6521107', folio: 'OF-5204', dealer: 'KIA Valle Oriente', modelo: 'Sonet', monto: 362000 },
  { vin: '3KPC24AD7PE097641', folio: 'OF-5207', dealer: 'KIA Patria', modelo: 'K3', monto: 396000 },
  { vin: 'KNADE163BP7743558', folio: 'OF-5210', dealer: 'KIA Querétaro', modelo: 'Seltos', monto: 472000 },
  { vin: '3KPA24AD9PE520488', folio: 'OF-5213', dealer: 'KIA Tijuana', modelo: 'Sportage', monto: 541000 },
  { vin: 'KNAD5813XP6521330', folio: 'OF-5216', dealer: 'KIA Mérida', modelo: 'Sonet', monto: 354000 }
]

export default function OpeningStep5RecepcionVin() {
