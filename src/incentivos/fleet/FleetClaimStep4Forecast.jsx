...
export default function FleetClaimStep4Forecast() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle
        kicker="Paso 4 · Forecast"
        title="Forecast de la oferta de flotilla"
        desc="Con los planes de flotilla aceptados, se estima por dealer y por modelo cuántas unidades se colocarán en el periodo sobre el histórico de los últimos 24 meses. KIA BRAIN corre la estimación y explica cómo llegó a cada cifra."
