...
export default function FidelityStep3Revision() {
        ...
        <Card className="overflow-hidden">
          ...
          <div className="p-5 space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 text-sm">
              ...
              <div><span className="text-kia-gray">Asunto:</span> <span className="font-semibold">Diferencia en forecast KIA Fidelity · {OF_PERIODO}</span></div>
            </div>
            <div className="rounded-xl border border-kia-line bg-slate-50/60 p-4 text-sm leading-relaxed">
              ...
              <p className="mt-2">En la revisión del forecast de KIA Fidelity de <strong>{OF_PERIODO}</strong> identificamos una diferencia en contra de <strong>{fmtMXN(t.montoEnContra)}</strong> en {t.enContra} dealer(s), donde el monto proyectado por KIA supera su forecast:</p>
